...
exports.findDefinitionsAtPosition = exports.validateTextDocument = void 0;
...
function findDefinitionsAtPosition(uri, documents, position) {
    ...
    const results = (0, teo_language_server_wasm_1.find_definitions)(sanitizedUri, unsavedFiles, [position.line + 1, position.character + 1]);
